...
# Shortcut: push nvidia-nim chart from NGC to OCI (requires NGC_API_KEY)
push-nvidia-nim version="1.0.3" oci-registry=OCI_REGISTRY:
    ./scripts/push-helm-from-ngc.sh nvidia-nim nim-llm {{version}} {{oci-registry}}
...
# Shortcut: push nvidia-nim chart from NGC and generate scaffold (requires NGC_API_KEY)
add-nvidia-nim version="1.0.3" oci-registry=OCI_REGISTRY:
    just push-nvidia-nim {{version}} {{oci-registry}}
    just generate-app nvidia-nim {{version}}
