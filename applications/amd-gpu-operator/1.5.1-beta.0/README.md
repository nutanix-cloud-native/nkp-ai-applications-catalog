...
| Component | Image | Tag |
|---|---|---|
| GPU Operator Controller | `docker.io/rocm/gpu-operator` | `v1.5.1-beta.0` |
| GPU Operator Utils | `docker.io/rocm/gpu-operator-utils` | `v1.5.1-beta.0` |
| Device Metrics Exporter | `docker.io/rocm/device-metrics-exporter` | `v1.5.1-beta.0` |
